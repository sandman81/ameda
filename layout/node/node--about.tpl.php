...
<div class="page-video-content">
	<div class="page-video-content_poster">
		<?php print render($content['field_about_video_img'][0]); ?>
		<div class="content-center">
			<div class="page-video-content_poster-desc">
				<?php print render($content['field_about_video_desc'][0]); ?>	
				<i id="play-button" class="page-video-content_poster-but"></i> 	
			</div>				 
		</div>	
	</div>
	<div class="page-video-content_video">
		<?php print render($content['field_about_video'][0]); ?>
	</div>
</div>
...
<div class="open-about-bottom">
	<div class="content-center">
		<div class="about-doctors">
			<h2 class="front-doctors_title">
				<?php $block = module_invoke('views', 'block_view', 'doctors-block_2'); print render($block['subject']); ?>
			</h2>
			<?php $block = module_invoke('views', 'block_view', 'doctors-block_2'); print render($block['content']); ?>
		</div>
		<div class="open-about-bottom_text">
			<?php print render($content['field_about_bottom'][0]); ?>
		</div>
	</div>
</div>
