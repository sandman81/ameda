...
<div class="open-section-top">
	<div class="content-center">
		<div class="open-section-top_banner">
			<?php print render($content['field_serv_banner'][0]); ?>
		</div>
	...
	<div class="content-center">
        ...
        <div class="front-doctors">
			<h2 class="front-doctors_title">
				<?php $block = module_invoke('views', 'block_view', 'doctors-block_4'); print render($block['subject']); ?>
			</h2>
			<?php $block = module_invoke('views', 'block_view', 'doctors-block_4'); print render($block['content']); ?>
		</div>
	</div>
</div>
...
<div class="open-programm-bottom">
	<div class="content-center">
		<div class="static-text">
			<?php print render($content['field_serv_bottom'][0]); ?>	
		</div>
	</div>
</div>
