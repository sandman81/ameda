...
<div class="open-section-top">
	<div class="content-center">
		<div class="open-section-top_services">
			<?php $block = module_invoke('views', 'block_view', 'section_services-block'); print render($block['content']); ?>
		</div>
		<div class="open-section-top_services-med">
			<div class="open-section-top_services-med-but">
				Пожалуйста, выберите услугу
				<i></i>
			</div>
			<div class="open-section-top_services-med-dropdown">
				<?php $block = module_invoke('views', 'block_view', 'section_services-block'); print render($block['content']); ?>
			</div>
		</div>
		<div class="open-section-top_banner">
			<?php print render($content['field_sec_banner'][0]); ?>
		</div>
		<div class="open-section-top_text static-text">
	...
	<div class="content-center">
        ...
        <div class="front-doctors">
			<h2 class="front-doctors_title">
				<?php $block = module_invoke('views', 'block_view', 'doctors-block_3'); print render($block['subject']); ?>
			</h2>
			<?php $block = module_invoke('views', 'block_view', 'doctors-block_3'); print render($block['content']); ?>
		</div>
	</div>
</div>
...
<div class="open-programm-bottom">
	<div class="content-center">
		<div class="static-text">
			<?php print render($content['field_sec_bottom'][0]); ?>	
		</div>
	</div>
</div>
